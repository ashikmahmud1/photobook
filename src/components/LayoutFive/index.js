        ...
        <Fragment>
            ...
            <div className="layout5">
                <div className="layout5-input-container">
                    <textarea className="layout5-input" placeholder="type text here" value={page.text1}
                ...
                <div className="layout5-image-container">
                    <div className="layout5-one-image-container">
                        {page.image1.file_id !== '' && <img src={IMAGE_SERVER_URL + page.image1.file_reference + '200'} alt="" className="layout5-one-image-container-image"/>}
                        {page.image1.file_id === '' && <PageFileUploader page={page} page_index={page_index} image='1'
                                           className='layout5-image1-uploader'/>}
                    </div>
                    <div className="layout5-two-image-container">
                        <div className="layout5-two-image-container1">
                            {page.image2.file_id !== '' && <img src={IMAGE_SERVER_URL + page.image2.file_reference + '200'} alt="" className="layout5-two-image-container1-image"/>}
                            {page.image2.file_id === '' && <PageFileUploader page={page} page_index={page_index} image='2'
                                               className='layout5-image2-uploader'/>}
                        </div>
                        <div className="layout5-two-image-container2">
                            {page.image3.file_id !== '' && <img src={IMAGE_SERVER_URL + page.image2.file_reference + '200'} alt="" className="layout5-two-image-container2-image"/>}
                            {page.image3.file_id === '' && <PageFileUploader page={page} page_index={page_index} image='3'
                                               className='layout5-image3-uploader'/>}
                        </div>
                    </div>
                </div>
            </div>
