        ...
        case actionTypes.PROCESS_IMAGE_SUCCESS: {
            ...
            if (typeof file_info.file === 'undefined' || file_info.file == null) {
                ...
                if (localStorage.getItem('photo_book') && file_info.file.path === path) {
                    ...
                    let {front, back, pages} = photo_book;
                    console.log(photo_book);
                    console.log(front);
                    if (file_info.page_index === 'front') {
                        switch (file_info.image) {
                            case '1':
                                front.image1 = image_object;
                                break;
                            case '2':
                                front.image2 = image_object;
                                break;
                            case '3':
                                front.image3 = image_object;
                                break;
                            default:
                                front.image1 = image_object
                        }
                    } else if (file_info.page_index === 'back') {
                        switch (file_info.image) {
                            case '1':
                                back.image1 = image_object;
                                break;
                            case '2':
                                back.image2 = image_object;
                                break;
                            case '3':
                                back.image3 = image_object;
                                break;
                            default:
                                back.image1 = image_object
                        }
                        ...
                        switch (file_info.image) {
                            case '1':
                                pages[file_info.page_index].image1 = image_object;
                                break;
                            case '2':
                                pages[file_info.page_index].image2 = image_object;
                                break;
                            case '3':
                                pages[file_info.page_index].image3 = image_object;
                                break;
                            default:
                                pages[file_info.page_index].image1 = image_object
                        }
                    ...
                    photo_book.front = front;
                    photo_book.back = back;
